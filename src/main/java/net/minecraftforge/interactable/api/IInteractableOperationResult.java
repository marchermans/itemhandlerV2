...
public interface IInteractableOperationResult<T> {
    ...
    enum Status {
        ...
        /**
         * The interactable transaction succeeded.
         */
        SUCCESS,
         ...
         *
         * In that case the {@link IInteractableOperationResult#getPrimary()} method will contain the remainder,
         * and this state indicates that a partial insertion was successful, yet without modification of slots
         * no more insertion into the interactable is possible.
         */
        CONFLICTING,

        /**
         * When inserting, the targeted slot of the interactable is full.
         * When extracting, the targeted slot of the interactable is empty.
         */
        FAILURE,
